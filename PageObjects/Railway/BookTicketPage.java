...
public class BookTicketPage extends GeneralPage{
    ...
    public WebElement getLoc_LblSuccess(){return Constant.WEBDRIVER.findElement(loc_lblSuccessMessage);}
    ...
    public String getLblSuccessMessage(){return getLoc_LblSuccess().getText();}
